          ...
          <div className="border border-gray-200 rounded-lg">
            ...
            <div className=" border border-gray-200 rounded-lg bg-gray-50 mx-6 mt-4 mb-6">
              ...
              <div className="flex items-center justify-end px-3 py-2 border-t ">
                <button
                  type="submit"
                  className="inline-flex items-center py-2.5 px-6 mr-3 text-[1.02rem] font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200  hover:bg-blue-800"
                >
                  Submit Query
                </button>
              </div>
